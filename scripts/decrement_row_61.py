...
old=int(qm.group()); new=max(old-1,0)
# update row data-quantity
...
Path('row61_quantity_verification.txt').write_text(f"Entry 61: Brand={brand!r}; Line={line!r}; Vitola={vitola!r}; Quantity {old} -> {new}\n",encoding='utf-8')
